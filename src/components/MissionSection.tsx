    ...
    <section className="section-padding bg-gradient-to-br from-primary-50 to-white fade-in-section">
      <div className="container">
        <div className="text-center mb-16">
          <h2 className="heading-section">Our Mission & Goals</h2>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-16">
          <div className="card-hover scale-in text-center">
            <div className="w-16 h-16 bg-gradient-to-br from-primary-400 to-primary-600 rounded-full mx-auto mb-6 flex items-center justify-center">
              <span className="text-2xl">💙</span>
            </div>
            <h3 className="bubble-text-sm text-primary-600 mb-4">Empower Dreams</h3>
          ...
          <div className="card-hover scale-in text-center">
            <div className="w-16 h-16 bg-gradient-to-br from-sky-light to-primary-500 rounded-full mx-auto mb-6 flex items-center justify-center">
              <span className="text-2xl">🌟</span>
            </div>
            <h3 className="bubble-text-sm text-primary-600 mb-4">Build Community</h3>
            <p className="text-section">
          ...
          <div className="card-hover scale-in text-center">
            <div className="w-16 h-16 bg-gradient-to-br from-primary-300 to-sky-medium rounded-full mx-auto mb-6 flex items-center justify-center">
              <span className="text-2xl">🚀</span>
            </div>
            <h3 className="bubble-text-sm text-primary-600 mb-4">Create Impact</h3>
            <p className="text-section">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-6">
            <div className="card-hover scale-in">
              ...
              <ul className="space-y-3 text-section">
            ...
            <div className="bg-gradient-to-r from-primary-500 to-sky-medium p-6 rounded-xl text-white card-3d scale-in">
